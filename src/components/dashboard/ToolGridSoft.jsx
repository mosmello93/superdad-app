    ...
    return (
        <div className="relative mb-8">
            ...
            <div className="grid grid-cols-2 gap-4">
                ...
                {mode === 'pregnancy' && (
                    <div onClick={toggleTimer} className="bg-[#E0E7FF] dark:bg-indigo-900/40 p-6 rounded-[32px] cursor-pointer transition hover:shadow-md border border-indigo-100/50 dark:border-indigo-800/50 group overflow-hidden relative">
                ...
                <div onClick={openEmergency} className="bg-[#FEE2E2] dark:bg-red-900/40 p-6 rounded-[32px] cursor-pointer transition hover:shadow-md border border-red-100/50 dark:border-red-800/50 group overflow-hidden">
                ...
                {/* SLOT 3: CLINIC BAG */}
                {mode !== 'postpartum' && (
                    <div onClick={openBag} className="bg-[#FFEDD5] dark:bg-orange-900/40 p-6 rounded-[32px] cursor-pointer transition hover:shadow-md border border-orange-100/50 dark:border-orange-800/50 group relative">
                ...
                {/* SLOT 4: BUREAUCRACY */}
                <div onClick={openBureaucracy} className="bg-[#F0FDF4] dark:bg-emerald-900/40 p-6 rounded-[32px] cursor-pointer transition hover:shadow-md border border-emerald-100/50 dark:border-emerald-800/50 group overflow-hidden">
                ...
                {/* SLOT 5: RESOURCES */}
                <div onClick={openResources} className="bg-[#F3F4F6] dark:bg-stone-800 p-6 rounded-[32px] cursor-pointer transition hover:shadow-md border border-gray-100/50 dark:border-stone-700/50 group overflow-hidden">
