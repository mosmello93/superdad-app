...
const ToolGridSoft = ({ mode, toggleTimer, openBag, openMilestones, openShield, openBureaucracy, openResources, openEmergency }) => {
    return (
        <div className="relative mb-8">
            {/* Mascot Decoration */}
            {/* Mascot Decoration */}
            <div className="absolute -top-16 -right-2 pointer-events-none opacity-100 z-10">
                <img src="/mascot/papa_builder.png" alt="Papa Builder" className="w-24 h-24 object-contain drop-shadow-xl transform rotate-3" />
            </div>
