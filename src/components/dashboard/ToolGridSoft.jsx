...
const ToolGridSoft = ({ mode, toggleTimer, openBag, openMilestones, openShield, openBureaucracy, openResources, openEmergency }) => {
    return (
        <div className="grid grid-cols-2 gap-4 mb-8">
            ...
            {mode === 'pregnancy' && (
                <div onClick={toggleTimer} className="bg-[#E0E7FF] p-6 rounded-[32px] cursor-pointer transition hover:shadow-md border border-indigo-100/50 group">
            ...
            {mode === 'loss' && (
                <div onClick={openShield} className="bg-[#F5F5F4] p-6 rounded-[32px] cursor-pointer transition hover:shadow-md border border-stone-200/50 group">
            ...
            <div onClick={openEmergency} className="bg-[#FEE2E2] p-6 rounded-[32px] cursor-pointer transition hover:shadow-md border border-red-100/50 group">
            ...
            {/* SLOT 3: CLINIC BAG */}
            <div onClick={openBag} className="bg-[#FFEDD5] p-6 rounded-[32px] cursor-pointer transition hover:shadow-md border border-orange-100/50 group">
            ...
            {/* SLOT 4: BUREAUCRACY */}
            <div onClick={openBureaucracy} className="bg-[#F0FDF4] p-6 rounded-[32px] cursor-pointer transition hover:shadow-md border border-emerald-100/50 group">
            ...
            {/* SLOT 5: RESOURCES */}
            <div onClick={openResources} className="bg-[#F3F4F6] p-6 rounded-[32px] cursor-pointer transition hover:shadow-md border border-gray-100/50 group">
