        ...
        <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center pointer-events-none">
            ...
            <div className="bg-[#F5F5F0] dark:bg-stone-950 w-full max-w-md h-[85vh] sm:h-[auto] rounded-t-[32px] sm:rounded-[32px] shadow-2xl overflow-hidden flex flex-col pointer-events-auto animate-in slide-in-from-bottom duration-300 relative">
                ...
                <div className="bg-white dark:bg-stone-900 p-6 pb-4 border-b border-stone-100 dark:border-stone-800 flex justify-between items-center sticky top-0 z-10">
                    <div><h2 className="text-2xl font-bold text-stone-800 dark:text-stone-100">Notfall-Infos</h2><p className="text-stone-500 dark:text-stone-400 text-xs">Alles griffbereit wenn's losgeht.</p></div>
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-6">
                    ...
                    <div className="bg-white dark:bg-stone-900 p-5 rounded-2xl shadow-sm border border-stone-100 dark:border-stone-800">
                        <div className="flex items-center mb-4"><MapPin size={18} className="text-rose-500 mr-2" /><h3 className="font-bold text-stone-700 dark:text-stone-200">Die Klinik</h3></div>
                        {editMode ? (
                            <div className="space-y-3">
                                <input placeholder="Name der Klinik" className="w-full bg-stone-50 dark:bg-stone-800 p-3 rounded-xl text-sm text-stone-900 dark:text-stone-100" value={localContacts.clinicName || ''} onChange={(e) => handleChange('clinicName', e.target.value)} />
                            ...
                            <div>
                                <p className="font-bold text-lg text-stone-800 dark:text-stone-100">{localContacts.clinicName || 'Klinik noch nicht eingetragen'}</p>
                    ...
                    <div className="space-y-4">
                        ...
                        {[{ id: 'midwife', icon: Phone, label: 'Hebamme', color: 'emerald' }, { id: 'doctor', icon: Activity, label: 'Kreißsaal / Arzt', color: 'indigo' }, { id: 'pediatrician', icon: Activity, label: 'Kinderarzt', color: 'blue' }, { id: 'taxi', icon: Phone, label: 'Taxi / Support', color: 'amber' }].map(contact => (
