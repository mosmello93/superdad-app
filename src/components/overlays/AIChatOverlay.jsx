...
const AIChatOverlay = ({ onClose, mode, babyName }) => {
    ...
    const handleSend = async () => {
        ...
        const context = mode === 'loss'
            ? "Du bist ein verständnisvoller Begleiter für einen Vater, der einen Verlust erlitten hat. Antworte kurz, empathisch und unterstützend."
            : `Du bist ein erfahrener 'SuperDad' Coach. Du sprichst mit einem werdenden/frischen Vater (Modus: ${mode}). 
               Name des Kindes (falls bekannt): ${babyName || 'das Baby'}.
               Antworte kurz (max 3 Sätze), locker, duzend, aber kompetent.`;
